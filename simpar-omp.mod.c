...
#line 68 "simpar-omp.c"
	#pragma omp parallel     reduction(+:masssum)
...
#line 127 "simpar-omp.c"
POMP_Parallel_fork(&omp_rd_6);
#line 127 "simpar-omp.c"
		#pragma omp parallel     private(k) reduction(+:xcm) reduction(+:ycm)
